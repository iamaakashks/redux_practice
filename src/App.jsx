...
import { increment, decrement, incrementByAmount, reset } from './store/reducers/counterSlice';
  ...
  return (
    <div className="bg-zinc-900 text-zinc-50 w-full h-screen">
      ...
      <div className="text-center">
        ...
        <button onClick={()=> dispatch(incrementByAmount(5))} type="button" className="px-4 py-1.5 border-[1px] border-zinc-700 rounded text-zinc-50 font-medium duration-500 hover:bg-gradient-to-b from-blue-900 via-green-400 hover:bg-clip-text hover:text-transparent">Increment by 5</button>
